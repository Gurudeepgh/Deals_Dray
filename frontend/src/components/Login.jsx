...
const Login = () => {
    ...
    return (
        <div>
            <div className=' max-w-[700px]  h-[450px] border-4 border-grey-900 mx-auto shadow-xl scale-75 p-[30px]'>
                ...
                <button className='bg-green-300 ml-5 rounded-lg p-1' onClick={login}>LOGIN</button>
                <br />
