...
const CreateEmployee = () => {
    ...
    let formHandle = (e) => {
        ...
        return (
            <div className=' max-w-[940px]  h-[600px] border-4 border-grey-900 mx-auto relative top-[-80px] shadow-xl scale-75 p-[30px]'>
                <h1 className='text-center font-bold text-2xl my-3'>Create Employee</h1>
                <div className='border border-gray-600 max-w-[300px] mx-auto my-5 p-8'>
                    ...
                    <button className='bg-green-300 ml-5 rounded-lg p-1' onClick={formHandle}>Register Me</button>
                </div>
